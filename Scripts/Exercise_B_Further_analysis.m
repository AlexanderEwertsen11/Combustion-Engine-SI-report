...
function [IMEP, PMEP, V, AHRR, AHR, T] = Exercise_B_Further_analysis(theta, ave_pressure, S, B, L, CR, T_intake, gamma)
%% Function
...
n = ave_pressure(360)*V(360)/(R*T1);

%Gas temperature as a function of CAD
T = ave_pressure.*V'/(n*R);
