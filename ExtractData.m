...
xlsversion = 'xls95'; % Options are 'xls97' and 'xls95'. MAC shoud use 'xls95'
...
if BuildRawDataBase
    ...
    VariableList1 = {
    'Group' 'p_atm' 'Date' 'Fuel' 'Engine speed' 'DAQ folder' 'Motoring file'
    };
    
    VariableList2 = {
    'Test nr.' 'Ignition timing' 'Lambda' 'CR' 'Torque' 'Air mass flow' 'Fuel mass flow' 'T_intake' 'T_oil' 'T_exh' 'T_head' 'T_cool out' 'T_cool in' 'Cool flow' 'H2O' 'CO2' 'CO' 'NO' 'NO2' 'CH2O' 'C3H8' 'O2' 'p_man' 'Knock' 'Pressure file' 'CR sweep' 'Ignition sweep' 'Pressure sweep' 'Lambda sweep'
    };
